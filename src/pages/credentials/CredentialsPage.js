...
import { PlusIcon, DocumentDuplicateIcon, DocumentSearchIcon } from '@heroicons/react/outline';
    ...
    <Layout title="Credentials Management">
      <div className="space-y-6">
        ...
        <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center space-y-2 sm:space-y-0">
          <h2 className="text-lg font-medium text-gray-900">Credential Management</h2>
                  ...
                  <div className="px-4 py-4 sm:px-6">
                    ...
                    <div className="mt-2 sm:flex sm:justify-between">
                      ...
                      <div className="mt-2 flex items-center text-sm text-gray-500 sm:mt-0">
                        <p>
                          Issued on: <time dateTime="2020-01-07">January 7, 2020</time>
                        </p>
                      </div>
                    </div>
                  </div>
